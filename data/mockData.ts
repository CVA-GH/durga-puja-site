...
export const defaultCommittee: CommitteeMember[] = [
  {
    _id: "comm-1",
    name: "Sri. Palash Ghosh",
    bengaliName: "শ্রী পলাশ ঘোষ",
    designation: "President (সভাপতি)",
    roleCategory: "executive",
    photo: "https://6a9d01a81c783ce433756ce5.imgix.net/Mr%20Palash%20Ghosh%20-%20President.jpg?auto=format&fit=crop&w=600&q=80",
  ...
  {
    _id: "comm-2",
    name: "Sri Bismoi Majumdar",
    bengaliName: "শ্রী বিস্ময় মজুমদার",
    designation: "General Secretary (সাধারণ সম্পাদক)",
    roleCategory: "executive",
    photo: "https://6a9d01a81c783ce433756ce5.imgix.net/Mr%20Bismoy%20Majumdar%20-%20Secretary.jpg?auto=format&fit=crop&w=600&q=80",
